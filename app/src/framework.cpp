...
void Framework::saveToFile(TextureData& texture, std::string& name) {
    std::fstream file("../Resources/saves/" + name);
}

void Framework::loadFromFile(TextureData& texture, std::string& name) {
    std::fstream file("../Resources/saves/" + name);
}
