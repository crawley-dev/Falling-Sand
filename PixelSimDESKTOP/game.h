...
private:
    ...
    void updateChunk(Chunk* c, bool updateLeft);
    void updateCell(Cell& c, s32 x, s32 y);
    void updateSand(Cell& c, s32 x, s32 y);
    void updateWater(Cell& c, s32 x, s32 y);
    void updateNaturalGas(Cell& c, s32 x, s32 y);
    ...
    std::vector<std::pair<std::vector<u8>, Vec2<s32>>> textureChanges;
    ...
    //std::unordered_map<Vec2<s16>, Chunk*, boost::hash<Vec2<s16>>> chunkMap;
